<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="removeworkouts.aspx.cs" Inherits="removeworkouts" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; <asp:Panel ID="Panel1" runat="server" Height="437px" style="margin-top: 52px; margin-left: 21px;">
        ...
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label2" runat="server" Font-Italic="True" Font-Size="Large" Text="REMOVE WORKOUTS"></asp:Label>
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Height="267px" OnSelectedIndexChanged="DataGrid1_SelectedIndexChanged" Width="707px" style="margin-top: 61px">
            <Columns>
                <asp:BoundColumn DataField="name" HeaderText="Workout Name"></asp:BoundColumn>
                <asp:BoundColumn DataField="part" HeaderText="Body Part"></asp:BoundColumn>
                <asp:BoundColumn DataField="difficulty" HeaderText="Difficulty"></asp:BoundColumn>
                <asp:BoundColumn DataField="description" HeaderText="Description"></asp:BoundColumn>
                <asp:BoundColumn DataField="reps" HeaderText="Number Of Reps"></asp:BoundColumn>
